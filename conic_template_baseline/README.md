...
As this directory has been already populated with a working example, it's recomended for participant to study it to grasp a good understanding of what is needed for a docker submission to CoNIC challenge.
...
In this example, we are focusing on the `conic_template_baseline`.
