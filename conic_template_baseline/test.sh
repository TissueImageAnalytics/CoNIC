...
docker run \
        ...
        --gpus all \
        --memory=32g \
        --mount src="/mnt/storage_0/workspace/nuclei/conic-challenge/docker/evaluation/data/phase-1-images/",target=/input/,type=bind \
        --mount src="/mnt/storage_0/workspace/nuclei/conic-challenge/exp_output/dump/",target=/output/,type=bind \
        conic-inference
printf "\n======================================\n"
